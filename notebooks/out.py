...
# Concatenate copes before feeding to Flameo
l3_merge_copes = pe.Node(
    interface=fsl.Merge(
        dimension='t'),
    name="l3_merge_copes")

l3_merge_varcopes = pe.Node(
    interface=fsl.Merge(
        dimension='t'),
...
glm.connect(fixed_fx, "applywarp_copes.out_file", mixed_fx, "l3_merge_copes.in_files")
glm.connect(fixed_fx, "applywarp_varcopes.out_file", mixed_fx, "l3_merge_varcopes.in_files")
